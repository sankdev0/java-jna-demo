...
/**
 * JNA mapping interface that mirrors win32 api advapi32 functions. Extends {@link
 * com.sun.jna.win32.StdCallLibrary} because advapi32.dll uses the __stdcall calling convention
 */
public interface Advapi32Lib extends StdCallLibrary {
   ...
   *
   * @param buffer Буфер для получения имени пользователя для входа в систему.
   * @param len    На входе - размер буфера, на выходе - количество символов, скопированных в буфер,
